...
public class ScheduleController {
    ...
    public ResponseEntity<ApiResponse<ScheduleResponse>> assignRoom(
            @PathVariable UUID id,
            @RequestBody @Valid ScheduleAssignRoomRequest request
    ) {
        return scheduleService.assignRoom(id, request);
    }
